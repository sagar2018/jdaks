...
<div class="d-flex align-items-center mb-4">
    ...
    <h4 class="fw-bold mb-0">Edit BOQ Item</h4>
</div>
    ...
    <div class="col-lg-7">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form method="POST" action="{{ route('projects.boq.update', [$project, $boq]) }}">
                    @csrf @method('PUT')
                    @include('boq._form', ['item' => $boq])
